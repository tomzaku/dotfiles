...
local def_map = {
    -- Vim map
    ["n|<F1>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F1>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F2>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F3>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F4>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F5>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F6>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F7>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F8>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F9>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F10>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F11>"]       = map_cmd('<nop>'), -- ignore F1
    ["i|<F12>"]       = map_cmd('<nop>'), -- ignore F1
    ["n|ss"]         = map_cu(':split'),
    ["n|sv"]         = map_cu(':vsplit'),
    ...
    --["n|<C-[>"]      = map_cr('vertical resize -5'):with_silent(),
    --["n|<C-]>"]      = map_cr('vertical resize +5'):with_silent(),
    ["n|<C-q>"]      = map_cmd(':wq<CR>'),
