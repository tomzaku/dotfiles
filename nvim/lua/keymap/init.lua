...
local plug_map = {
    ...
    ["n|<F2>"]             = map_cr('Lspsaga rename'):with_noremap():with_silent(),
    ...
    --
    --Plugin NERD TREE
    -- ["n|<Leader>e"]      = map_cr(':NERDTreeToggle'):with_noremap():with_silent(),
    -- ["n|<Leader>F"]      = map_cr(':NERDTreeFind'):with_noremap():with_silent(),
    ...
    -- Far.vim - Replace to nvim-spectree
    ...
    ["n|<Leader>S"]      = map_cu("<cmd>lua require('spectre').open_file_search()<CR>"),
    -- Plugin Telescope
    ...
    ["n|<Leader>fw"]     = map_cu('lua require("telescope.builtin").grep_string({ search = vim.fn.input("Grep For > ")})'):with_noremap():with_silent(),
    ...
    -- QuickList
    ["n|<Leader>h"]      = map_cr(':cprev'):with_silent(),
    ["n|<Leader>l"]      = map_cr(':cnext'):with_silent(),
    -- Plugin Vista
    ...
    -- TrueZen
    ["n|<Leader>z"]      = map_cr(':TZFocus'):with_noremap():with_silent(),
