...
local mappings = {
    ...
    f = {
        name = "Finding",
        f = { "<cmd>lua require('telescope.builtin').find_files({layout_strategy='vertical',layout_config={width=0.99, height=0.99}}) <cr>", "Find files" },
        r = {"<cmd>lua require('telescope.builtin').resume()<cr>", "Resumne the previous telescope picker"},
        h = { "<cmd>Telescope oldfiles cwd_only=v:true<cr>", "History files" },
        w = { "<cmd>lua require('telescope.builtin').live_grep({layout_strategy='vertical',layout_config={width=0.99, height=0.99}})<cr>", "Find words" },
